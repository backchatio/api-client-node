...
var ResponseHandler = function(meta) {
  ...
  this.handle = function(error, response, body) {
    var errors, data, json = null, code = response.statusCode;
...
module.exports.open = function(apiKey, options, callback) {
  ...
  Swagger.open(options.url, backchatAuthHeaders(options.apiKey),
    function(op) { return new ResponseHandler(op); },
    options.callback);
};
